    ...
    (function($) {
        ...
        IAS.prototype.next = function() {
            var url = this.nextUrl,
                self = this;
                var newitems= jQuery(".load-more-product-list li.item.product.product-item");
                var first=jQuery(".loadmore-count .first-number").text();
            ...
            if(newitems){
                ...
                first=first-1;
                jQuery(".toolbar .toolbar-number.page-count").text(newitems.length + first);
            }
            return true;
        };
    

        // jQuery(document).on("click", ".ias-trigger .load-more",function(){
        //     IAS.prototype.next();
        // })
